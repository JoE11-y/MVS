...
const nextConfig = {
  ...
  pageExtensions: ["ts", "page.tsx", "page.ts", "page.jsx", "page.js"],
   ...
   */
  basePath: process.env.NODE_ENV === "production" ? "/MVS" : "", // update if your repo name changes for 'npm run deploy' to work successfully
  assetPrefix: process.env.NODE_ENV === "production" ? "/MVS/" : "", // update if your repo name changes for 'npm run deploy' to work successfully
};
